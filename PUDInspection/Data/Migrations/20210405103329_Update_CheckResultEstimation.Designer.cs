...
namespace PUDInspection.Data.Migrations
{
    ...
    [Migration("20210405103329_Update_CheckResultEstimation")]
    partial class Update_CheckResultEstimation
    {
            ...
            modelBuilder.Entity("PUDInspection.Models.CheckResultEvaluation", b =>
                {
                    ...
                    b.HasOne("PUDInspection.Models.ApplicationUser", "Validator")
                        .WithMany("CheckResultEvaluations")
