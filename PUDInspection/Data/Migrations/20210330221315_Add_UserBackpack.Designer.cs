...
namespace PUDInspection.Data.Migrations
{
    ...
    [Migration("20210330221315_Add_UserBackpack")]
    partial class Add_UserBackpack
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PUDInspection.ViewModels.InspectPUDCriteriaViewModel", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<int>("CheckVsCriteriaId")
                        .HasColumnType("int");

                    b.Property<int?>("CriteriaId")
                        .HasColumnType("int");

                    b.Property<string>("InspectPUDViewModelId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("InspectPUDViewModelId");

                    b.ToTable("inspectPUDCriteriaViewModels");
                });

            modelBuilder.Entity("PUDInspection.ViewModels.InspectPUDViewModel", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("inspectPUDViewModels");
                });
            ...
            modelBuilder.Entity("PUDInspection.ViewModels.InspectPUDCriteriaViewModel", b =>
                {
                    ...
                    b.HasOne("PUDInspection.ViewModels.InspectPUDViewModel", null)
                        .WithMany("Criterias")
                        .HasForeignKey("InspectPUDViewModelId");
            ...
            modelBuilder.Entity("PUDInspection.Models.ApplicationUser", b =>
                {
                    ...
                    b.Navigation("inspectPUDViewModels");
